...
<?php if ($database->variablespermisos('', 'rechazo_pagoCOM', 'ver') == 'si') { ?>
...
<td style="text-align:center; background:
    ...
    <?php
        ...
        $permisoguardarRechazo = $database->variablespermisos('', 'rechazo_pagoCOM', 'guardar') == 'si';
        $permisomodificarRechazo = $database->variablespermisos('', 'rechazo_pagoCOM', 'modificar') == 'si';
    ...
    <input type="checkbox"
       ...
       if ($statusRechazado == 'si') {
            if($permisomodificarRechazo){
                  echo 'checked onchange="STATUS_RECHAZADO('.$row["07COMPROBACIONid"].')" title="Pago rechazado"';
            } else {
            ...
            if($permisoguardarRechazo || $permisomodificarRechazo){
               echo 'onchange="STATUS_RECHAZADO('.$row["07COMPROBACIONid"].')"';
            } else {
                echo 'disabled style="cursor:not-allowed;" title="Sin permiso para modificar"';
            }
        }
