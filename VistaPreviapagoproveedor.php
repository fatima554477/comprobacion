...
<tr style="background: #c3f5d9">
<td width="30%"><label>IMPUESTOS RETENIDOS  IVA:</label></td>
<td width="70%"><input type="text" name="TImpuestosRetenidosIVA"  value="'.$row["TImpuestosRetenidosIVA"].'"></td>
</tr> 

<tr style="background: #c3f5d9">
<td width="30%"><label>IMPUESTOS RETENIDOS  ISR:</label></td>
...
<tr  style="background: #c3f5d9">
<td width="30%"><label> IMPUESTO SOBRE HOSPEDAJE MÁS EL IMPUESTO DE SANEAMIENTO</label></td>
...
<tr >
<td width="30%"><label>TOTAL DE LA CONVERSIÓN </label></td>
